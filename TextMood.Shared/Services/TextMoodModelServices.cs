...
namespace TextMood.Shared
{
    ...
    {
        public static List<ITextMoodModel> GetRecentTextModels(in IEnumerable<ITextMoodModel> textMoodModelList, TimeSpan timeSpan) =>
        ...
        public static double GetAverageSentimentScore(in IList<ITextMoodModel> textMoodModelList) => textMoodModelList.Select(x => x.SentimentScore).Average() ?? -1;
    }
}
